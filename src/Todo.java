...
4. Implement the PriorityQueueHospital class
5. Do HealthyPerson compareToImpl method
6. Complete HealthyPerson toString()
7. Do SickPerson compareToImpl method
8. Complete SickPerson toString()
